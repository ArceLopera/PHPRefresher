...
Double-ended linked list data structure
...
| Feature | SplDoublyLinkedList | Alternative |
|---------|---------|-------------|
...
- [PHP SplDoublyLinkedList](https://www.php.net/manual/en/class.spl{title-lower}.php)
